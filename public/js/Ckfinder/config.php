...
//		return true;
//
//	if(!isset($_SESSION['_ACCESS_LIST']) || empty($_SESSION['_ACCESS_LIST']) || !isset($_SESSION['ADMIN_CKFINDER']))
//		return false;
//
//	if($_SESSION['ADMIN_CKFINDER'])
//		return true;
...
$baseUrl = SITE_ROOT.'/public/upload/temp/';
/*
