...
class FanweService
{
	...
	public $config = array();
	public $var = array();
	public $cache_list = array('goods_category','links','navs','business');
	...
	//测试 函数
	public function upyun_test($space_name='',$user='',$password=''){
	...
	public function initialize()
	{
		...
		if(file_exists(FANWE_ROOT."./public/adv_api/UpYun.php")){
			...
			if($this->upyun_test($upyun['space_name'],$upyun['user'],$upyun['password'])){
				
				define('IS_UPYUN',$upyun['status']);
			}else{
